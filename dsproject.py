...
import random
st.set_page_config(page_title="Athlete Multi-Event Dashboard", layout="wide", page_icon="run")
st.markdown("""
<style>
    .main {
...
if selected_athlete:
    ...
    if severe_cases > 0:
        ...
        st.warning("High average heart rate — possible overtraining detected.")
    else:
